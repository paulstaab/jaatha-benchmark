...
model_7par <- coal_model(c(15, 20), 500, 1000) +
  feat_mutation(par_range('theta', .1, 10)) +
  ...
  par_range("s1", 0.001, 2) + par_range("s2", 0.001, 2) +
...
testJaatha:::testJaatha(model_7par, 2, 1, seed=24680, smoothing=FALSE, cores=c(16, 2),
                       folder=file.path('runs', version, '7par'))
testJaatha:::testJaatha(model_7par, 2, 1, seed=24680, smoothing=TRUE, cores=c(16, 2),
                        folder=file.path('runs', version, '7par_smoothing'))
